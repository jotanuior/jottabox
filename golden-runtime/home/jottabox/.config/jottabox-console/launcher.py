#!/usr/bin/env python3
import os, time, math, shutil, subprocess, pygame, json, pty, select, re, signal
...
SET_ART={
 ...
 "keyboard":load_img("settings_gamepad.png"),
...
MENU_META={
 ...
 "keyboard":("CONFIGURAR TECLADO","Usar teclado físico como controle","⌨"),
